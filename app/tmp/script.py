...
if __name__=='__main__':
    ...
    parser.add_argument("--input_path", type=str, default="/nethome/projetos30/arcabouco_ml/adult.csv", help="Path to the input .csv file.")
    parser.add_argument("--output_path", type=str, default="/nethome/projetos30/arcabouco_ml/output", help="Path to where the output .pkl file should be saved.")    
